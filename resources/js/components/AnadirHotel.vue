    ...
    methods: {
      ...
      async añadirHotel() {
        ...
        try {
          ...
          if (response.ok) {
            console.log("Hotel añadido correctamente");
            window.location.href = "/gestionarhoteles?success=Hotel añadido correctamente";
          } else {
            const errorText = await response.text();
            console.error("Error al añadir el hotel:", errorText);
            this.errorMessage = `Error al añadir el hotel: ${errorText}`;
          }
        } catch (e) {
