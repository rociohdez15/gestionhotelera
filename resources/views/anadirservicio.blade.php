...
<head>
    ...
    <title>AlojaDirecto | Añadir Servicio</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <main>
        <div id="app5">
            ...
            <div data-reserva-id="{{ $reserva->reservaID }}"
                data-nombre="{{ $reserva->nombre }}"
                data-fecha-inicio="{{ $reserva->fechaInicio }}"
                data-fecha-fin="{{ $reserva->fechaFin }}">
                <!-- Puedes agregar más datos relacionados con la reserva si es necesario -->
            </div>
            @endforeach
        </div>
