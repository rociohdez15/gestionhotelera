...
<head>
    ...
    <title>AlojaDirecto | Registro</title>
    <!-- Bootstrap CSS -->
...
<body>
    <header>
        ...
        <div class="contenedor-titulos">
                ...
                <form action="{{ route('register') }}" method="post" class="needs-validation" novalidate style="max-width: 400px; margin: 0 auto;">
                    @csrf
                    <div class="form-group">
                        <label for="name" class="form-label text-start d-block">Nombre:</label>
                        <input type="name" class="form-control" id="name" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                        <div class="invalid-feedback">Por favor ingresa tu nombre.</div>
                    </div>
                    <br>
                    <div class="form-group">
                        <label for="apellidos" class="form-label text-start d-block">Apellidos:</label>
                        <input type="apellidos" class="form-control" id="apellidos" name="apellidos" value="{{ old('apellidos') }}" required autocomplete="apellidos" autofocus>
                        <div class="invalid-feedback">Por favor ingresa tus apellidos.</div>
                    </div>
                    <br>
                    <div class="form-group">
                        <label for="direccion" class="form-label text-start d-block">Direccion:</label>
                        <input type="direccion" class="form-control" id="direccion" name="direccion" value="{{ old('direccion') }}" required autocomplete="direccion" autofocus>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" id="telefono" name="telefono" value="{{ old('telefono') }}" required autocomplete="telefono" pattern="[0-9]{10,15}" title="El teléfono debe contener entre 10 y 15 dígitos.">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="dni" name="dni" value="{{ old('dni') }}" required autocomplete="dni">
                    ...
                    <br>
                    <div class="form-group">
                        <label for="password_confirmation" class="form-label text-start d-block">Confirmar contraseña:</label>
                        <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" required autocomplete="current-password_confirm">
                        <div class="invalid-feedback">Por favor ingresa tu contraseña nuevamente.</div>
                    </div>
                    <br>
                        <!-- Selecciona el rol del usuario (Cliente) directamente -->
