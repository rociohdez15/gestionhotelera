            ...
            <form action="{{ route('register') }}" method="post" class="needs-validation" novalidate style="max-width: 400px; margin: 0 auto;">
                ...
                <div class="col-12">
                    <div class="form-wrap">
                        ...
                        <input type="text" class="form-control" id="apellidos" name="apellidos" value="{{ old('apellidos') }}" required autocomplete="apellidos" autofocus>
                ...
                <div class="col-12">
                    <div class="form-wrap">
                        ...
                        <input type="text" class="form-control" id="direccion" name="direccion" value="{{ old('direccion') }}" required autocomplete="direccion" autofocus>
