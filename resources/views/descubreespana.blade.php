...
<body>
    ...
    <main>
        <br>
        <h3 class="text-center">Descubre España</h3>
        <br>
        ...
        <div class="container" style="max-width: 800px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #ffffff ;">
            <div class="row g-3">
                <!-- Imagen del hotel -->
                <div class="col-12 col-md-4">
                    @if ($hotel->imagen_url)
                    <img src="{{ asset($hotel->imagen_url) }}" alt="{{ $hotel->nombre }}" class="img-fluid rounded">
                    @endif
                </div>
