...
<head>
    ...
    <title>AlojaDirecto | Listado de Check-In</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <main>
        ...
        <div class="container">
            ...
            <br>
            <h2 class="text-center">LISTADO DE CHECK-IN</h2>

            <br>
            <!-- Buscador -->
            <form action="{{ route('buscarCheckin') }}" method="GET" class="mb-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if ($reserva->fecha_checkin == $fecha_actual)
                                ...
                                @else
                                <span class="text-muted">No se puede gestionar Check-in</span>
                                @endif
                            </td>
                        </tr>
                        @endforeach
