...
<head>
    ...
    <title>AlojaDirecto | Panel de Administración</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-lg-2 d-flex flex-column align-items-start border-end menu-opciones" style="height: 100vh; overflow-y: auto;">
                    ...
                    <ul class="nav flex-column w-100 txt-listado">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('listarUsuarios') }}">
                                <i class="fa-solid fa-user-plus me-2"></i>Alta de Administradores
                            </a>
                        </li>
                    </ul>
                </div>
